...
public class PlacesTwoAdapter extends RecyclerView.Adapter<PlacesTwoAdapter.PlaceViewHolder> {
    ...
    public PlacesTwoAdapter(List<String> places, OnPlaceClickListener listener) {
        this.places = places;
    ...
    public PlaceViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_place_two, parent, false);
