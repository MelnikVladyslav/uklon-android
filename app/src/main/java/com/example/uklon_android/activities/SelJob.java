...
public class SelJob extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selected_job);

        btnBack = findViewById(R.id.back);
        btnEnter = findViewById(R.id.enter);
        edName = findViewById(R.id.nameJob);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SelJob.this, MainActivity.class);
