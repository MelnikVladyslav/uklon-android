...
public class PayDrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PayDrActivity.this, DriverMainActivity.class);
        ...
        SC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    Intent scanIntent = new Intent(PayDrActivity.this, CardIOActivity.class);
            ...
            if (data != null && data.hasExtra(CardIOActivity.EXTRA_SCAN_RESULT)) {
                ...
                apiService.addCard(newCard).enqueue(new Callback<Card>() {
                    ...
                    public void onResponse(Call<Card> call, Response<Card> response) {
                        Toast.makeText(PayDrActivity.this, "Картку додано " + response.hashCode(), Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(Call<Card> call, Throwable t) {
                        Toast.makeText(PayDrActivity.this, "Помилка: " + t.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
