    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap map) {
                ...
                googleMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(SearchTaxiActivity.this, R.raw.map));

                // Ініціалізація FusedLocationProviderClient
                fusedLocationClient = LocationServices.getFusedLocationProviderClient(SearchTaxiActivity.this);
        ...
        tvTypeName.setText(curType.getName());
        ...
        apiService.getUsers().enqueue(new Callback<List<User>>() {
            ...
            public void onResponse(Call<List<User>> call, Response<List<User>> response) {
                ...
                if(driver != null)
                {
                    Intent intent = new Intent(SearchTaxiActivity.this, OTActivity.class);
